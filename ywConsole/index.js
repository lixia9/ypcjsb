...
\
<div class="at-entry" nc-id="atEntry" onclick="toggleEntry()"  ontouchstart="touchStart(event)" style="transform: translate3d({{tx}}px,{{ty}}px,0px);-webkit-transform: translate3d({{tx}}px,{{ty}}px,0px);">ywConsole</div>\
...
;(function () {
        ...
        initXHR:function(){
            (function(open){
                window.XMLHttpRequest.prototype.open=function(){
                    this.ywConsoleMethod=arguments[0];
                    this.ywConsoleUrl=arguments[1];
                    ...
                    if ((xhr.status >= 200 && xhr.status < 300) || xhr.status == 304) {
                        try {
                            self.option.xhrs.realPush({
                                method: xhr.ywConsoleMethod,
                                rqsUrl: xhr.ywConsoleUrl,
    ...
    window.ywConsole= ywConsole;
})();
})();
(function(){
    try {
        var al=new ywConsole({
            hide: true,
            reportTo: 'xxx',
            height: '55%',
            index: 1,
